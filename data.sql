...
SELECT first_name, last_name FROM customers JOIN reservations ON reservations.customer_id = customers.id
GROUP BY first_name, last_name;


SELECT customer_id, first_name, last_name, COUNT(customer_id) as num_reservations
...
SELECT first_name, last_name, COUNT(customer_id) as num_reservations
FROM customers JOIN reservations 
ON customers.id = reservations.customer_id
GROUP BY customers.first_name, customers.last_name
ORDER BY  COUNT(customer_id) DESC
